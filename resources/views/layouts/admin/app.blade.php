        ...
        <div class="aside-top">
         ...
         <nav>
            <ul class="menu-aside">
                ...
                <li class="menu-item has-submenu @if(isset($active) && $active == 'product') active @endif">
                ...
                <li class="menu-item has-submenu @if(isset($active) && $active == 'offers') active @endif">
                    ...
                    <div class="submenu">
                         ...
                         <a href="{{ url('createHomePageAds') }}">Home Page Ads [{{$home_page_ads}}]</a>
                         <a href="{{ url('createHomePageOffer') }}">Home Page Offer [{{$home_page_offers}}]</a>
                ...
                <li class="menu-item has-submenu @if(isset($active) && $active == 'settings') active @endif">
                    ...
                    <div class="submenu">
                         <a href="{{ url('viewShippingCategories') }}">Shipping</a>
                    </div>    
                </li>
                ...
                @if(Auth::user()->hasRole('webadmin'))
                    <li class="menu-item has-submenu @if(isset($active) && $active == 'roles') active @endif">
                        <a class="menu-link" href="page-products-list.html">
                            <i class="icon material-icons md-shopping_bag"></i>
                        ...
                        <div class="submenu">
                            ...
                            <!-- <a href="{{ url('viewCategories') }}">Add Roles & Permissions</a> -->
                        </div>
                    </li>
                @endif
                <li class="menu-item has-submenu @if(isset($active) && $active == 'users') active @endif">
                        <a class="menu-link" href="#">
