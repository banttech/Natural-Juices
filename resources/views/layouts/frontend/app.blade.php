...
<body>
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                            <div class="logo mb-15">
                                <a href="index.html" class="mb-15"><img src="{{ asset('imgs/theme/logo.png') }}" alt="logo" width="180px;" /></a>
                            </div>
                            <ul class="contact-infor">
                                <li><img src="{{ asset('imgs/theme/icons/icon-location.svg') }}"
                                        alt="" /><strong>Address: </strong> <span style="font-size: 13px;">NATURAL JUICES & VITAMINS LTD. </span> <br />
                                        <p style="font-size: 13px; margin-left: 23px;">BRAEMAR HOUSE <br /> 30 KINGS AVE <br /> SUNBURY ON THAMES <br /> MIDDLESEX <br /> TW16 7QE</li></p>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-6 text-center d-none d-xl-block">
                    ...
                    <div class="hotline d-lg-inline-flex">
                        <img src="{{ asset('imgs/theme/icons/phone-call.svg') }}" alt="hotline" style="margin-left: -11px;" />
    ...
    <div class="text-section" style="margin: 0 10px; margin-top: 30px">
        ...
        <br />
        Store health supplements in a cool dry place below 30'C, away from direct sunlight. For more details, follow the instructions on the packing.
        <br /><br />
