...
<body>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="invoice-numb">
                                            <h4 class="invoice-header-1 mb-10 mt-20">Invoice No: <span class="text-brand">#{{$invoice_number}}</span></h4>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="invoice-name text-end">
                                            <div class="logo">
                                                <a href="index.html"><img src="{{ asset('imgs/theme/logo.png') }}" alt="logo" width="180px;" /></a>
    ...
    <!-- Invoice JS -->
    <script src="{{ url('frontend/assets/js/invoice/jspdf.min.js') }}"></script>
    <script src="{{ url('frontend/assets/js/invoice/invoice.js') }}"></script>
</body>
