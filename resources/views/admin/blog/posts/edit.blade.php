...
<section class="content-main">
    ...
    <div class="card mb-4">
        <form method="POST" action="{{ url('updateBlogPost/' . $blogPost->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="mb-3">
                    <label class="form-label">Blog Status (Active / Inactive)</label><br />
                    &nbsp;&nbsp;<input type="checkbox" checked @if($blogPost->status == 'inactive') checked="false" @endif name="status">
                </div>
                <div class="row mb-3">
                    <div class="">
                        <label for="name" class="form-label">Title<span class="text-danger" style="font-size: 17px;">*</span></label>
                        <input type="text" value="{{ $blogPost->title }}" name="title" placeholder="Title" class="form-control" />
                        @if ($errors->has('title'))
                ...
                <div class="row mb-3">
                    <div class="">
                        ...
                        <input type="text" value="{{ $blogPost->sub_title }}" name="sub_title" placeholder="Sub Title" class="form-control" />
                ...
                <div class="mb-3">
                    ...
                    <textarea placeholder="Type here" id="editor" rows="4" cols="50" name="description">{{ $blogPost->description }}</textarea>
                 ...
                 <div class="row mb-3">
                    <div class="">
                        ...
                        <select class="form-control" id="js-example-basic-single" name="tags[]" multiple="multiple">
                            <?php $tags = explode(',', $blogPost->tags); ?>
                             @foreach ($tags as $tag)
               ...
               <div class="row mb-3">
                ...
                <div class="row mb-3">
                    <div>
                        ...
                        <br>
                        @if(isset($blogPost->feature_image) && $blogPost->feature_image != "")
                            <img src="{{ url('/images/blogPosts/'.$blogPost->feature_image) }}" style="width: 250px !important">
                        @endif
                    </div>
                </div>
                 <div class="row mb-3">
                    <div class="">
                        ...
                        <select class="form-control" id="respective-products" name="respective_products[]" multiple="multiple">
                            <option value=""></option>
                             ...
                             <option value="{{ $product->id }}" @if(in_array($product->id, $selectedBlogProducts)) selected @endif>{{ $product->prod_name }}</option>
                             @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="">
                        ...
                        <input type="text" value="{{ $blogPost->seo_title }}"name="seo_title" placeholder="Title" class="form-control" value="{{ old('seo_title') }}" />
                    </div>
                 ...
                 <div class="mb-3">
                    ...
                    <textarea placeholder="Type here" class="form-control" rows="4" name="seo_description">{{ $blogPost->seo_description }}</textarea>
