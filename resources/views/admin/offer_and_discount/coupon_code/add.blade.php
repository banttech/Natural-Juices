...
<section class="content-main">
    ...
    <div class="card mb-4">
        <form method="POST" action="{{ url('storeCouponCode') }}">
            @csrf
            <div class="card-body">
                <div class="row mb-3">
                    <div class="">
                        <label for="coupon_code" class="form-label">Coupon Code<span class="text-danger" style="font-size: 17px;">*</span></label>
                        <input type="text" value="{{ old('coupon_code') }}" name="coupon_code" placeholder="Coupon Code" class="form-control" />
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="coupon_type" value="{{ old('prod_discount_type') }}" onchange="parentDiscount(this.value)">
                ...
                <div class="row mb-3 parent_discount">
                    <div class="discount">
                        <input type="number" value="{{ old('discount') }}" placeholder="0.00" name="discount" class="form-control" />
                    </div>
                 ...
                 <div class="mb-3">
                    ...
                    &nbsp;&nbsp;<input type="checkbox" checked @if(old('coupon_status') == 'inactive') checked="false" @endif name="coupon_status">
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="usage_allowed" value="{{ old('usage_allowed') }}">
                        <option value="" selected="true" disabled="true">Select Usage Allowed</option>
                        <option value="limited use">Unlimited Use</option>
                ...
                <div class="mb-3">
                    ...
                    &nbsp;&nbsp;<input type="checkbox" class="parent_minimum_apply_coupon_code mb-3" onchange="enableDisableCouponCode()" />
                    <div class="minimum_apply_coupon_code">
                        <input type="number" value="{{ old('minimum_apply_value') }}" placeholder="0.00" name="minimum_apply_value" class="form-control" />
                    </div>
                ...
                <div class="mb-3">
                    ...
                    &nbsp;&nbsp;<input type="checkbox" class="parent_specific_category mb-3" onchange="enableDisableCategory()" />
                    <div class="specific_category">
                        <select class="form-select" name="apply_on_specific_category" value="{{ old('apply_on_specific_category') }}">
                ...
                <div class="mb-3">
                    ...
                    &nbsp;&nbsp;<input type="checkbox" class="parent_specific_brand mb-3" onchange="enableDisableBrand()" />
                    <div class="specific_brand">
                        <select class="form-select" name="apply_on_specific_brand" value="{{ old('apply_on_specific_brand') }}">
                ...
                <div class="mb-3">
                    ...
                    &nbsp;&nbsp;<input type="checkbox" name="show_on_cart_page" />
                </div>
                 <div class="mb-3">
