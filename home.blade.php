            ...
            <div class="section-title style-2">
                ...
                <ul class="nav nav-tabs links" id="myTab" role="tablist">
                    ...
                    @foreach($categories as $key => $category)
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="nav-tab-one" data-bs-toggle="tab" data-bs-target="#tab-one"
                                type="button" role="tab" aria-controls="tab-one" aria-selected="true">{{ $category->name }}</button>
                        </li>
                    @endforeach
                </ul>
            </div>
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-10-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset('imgs/shop/product-10-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-12-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset('imgs/shop/product-12-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-13-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset('imgs/shop/product-13-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-14-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset('imgs/shop/product-14-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-15-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset('imgs/shop/product-15-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-16-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset('imgs/shop/product-16-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-7-1.jpg') }}"
                                                alt="" />
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-8-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset('imgs/shop/product-8-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-9-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset('imgs/shop/product-9-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-6-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset('imgs/shop/product-6-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-5-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset('imgs/shop/product-5-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-4-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset('imgs/shop/product-4-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 d-none d-xl-block">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-1-1.jpg') }}"
                                                alt="" />
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img" src="{{ asset('imgs/shop/product-11-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img" src="{{ asset('imgs/shop/product-11-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
